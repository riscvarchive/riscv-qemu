        ...
        target_ulong csrno)
{
    ...
    case NEW_CSR_INSTRETW:
        fprintf(stderr, "WRITE TO CSR " TARGET_FMT_lx " not yet impl\n", csrno);
        exit(1);
        break;
    ...
    case NEW_CSR_MIPI: {
        // env->csr[NEW_CSR_MIP] |= MIP_MSIP;
        fprintf(stderr, "WRITE TO NEW_CSR " TARGET_FMT_lx " not yet impl\n", 
                csrno);
        exit(1);
        break;
    }
...
//        break;
    ...
    case NEW_CSR_INSTRETW:
        fprintf(stderr, "NOT YET IMPLEMENTED READ CSR 0x%x\n", csrno2);
        exit(1);
    case NEW_CSR_TIMEH:
    case NEW_CSR_TIMEHW:
        fprintf(stderr, "NOT YET IMPLEMENTED READ CSR 0x%x\n", csrno2);
    ...
    case NEW_CSR_UARCH15:
        printf("NOT YET IMPLEMENTED READ CSR 0x%x\n", csrno2);
        exit(1);
    default:
