...
bitslist = ['64', '32']
tests_dir = "/scratch/sagark/qemu-newpriv1.9-2/riscv-tools/riscv-tests/isa/"
...
if len(sys.argv) == 1:
    ...
    for bits in bitslist:
        cmd = "../riscv" + bits + "-softmmu/qemu-system-riscv" + bits + " -m 3840M -kernel " + tests_dir + "{} -nographic"
